...
def get_role_model_setting():
    return getattr(settings, 'ARCTIC_ROLE_MODEL', 'arctic.Role')


def get_user_role_model_setting():
    return getattr(settings, 'ARCTIC_USER_ROLE_MODEL', 'arctic.UserRole')
...
def get_role_model():
    ...
    """
    try:
        return django_apps.get_model(get_role_model_setting())
    except ValueError:
...
def get_user_role_model():
    ...
    """
    try:
        return django_apps.get_model(get_user_role_model_setting())
    except ValueError:
